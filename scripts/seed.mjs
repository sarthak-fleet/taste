...
const agents = [
  ["ag-ux", "ux_clarity", "UX Clarity Agent", "Evaluates layout hierarchy and next-action clarity.", "ux_clarity"],
  ["ag-skeptic", "skeptical_buyer", "Skeptical Target User", "Challenges value prop and trust signals.", "skeptical_buyer"],
  ["ag-conv", "conversion_funnel", "Conversion / Funnel Agent", "Analyzes CTA strength and signup intent.", "conversion"],
  ["ag-tech", "technical_user", "Technical User Agent", "Developer credibility and setup clarity.", "technical"],
  ["ag-copy", "copy_critic", "Copy Critic Agent", "Headline strength and messaging specificity.", "copy"],
  ["ag-a11y", "accessibility_basics", "Accessibility / Basics Agent", "Readability and layout basics.", "accessibility"],
];
