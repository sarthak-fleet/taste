...
export default function Dashboard() {
  ...
  const active =
    studies?.filter((s) =>
      ['evaluating', 'generating_report', 'pending_review'].includes(s.status)
    ) ?? [];
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Demo workspace — pre-A/B variant decisions
          </p>
        </div>
        <Button asChild>
          <Link to="/studies/new">
        ...
        <Card className="border-destructive/50">
          <CardContent className="p-6">
            ...
            <p className="text-sm text-muted-foreground mt-2">
              ...
              <code className="bg-muted px-1 rounded">pnpm db:migrate:local && pnpm db:seed</code>{' '}
              first.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-12 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Submit 2–5 variants to get your first recommendation.
            </p>
            <Button asChild>
