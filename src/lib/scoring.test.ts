...
describe("computeVariantRankings", () => {
  ...
  it("ranks variants by overall score descending", () => {
    const rankings = computeVariantRankings(
      [
        { variantId: "a", variantLabel: "A", variantName: "Alpha", targetUserScore: 3, expertScore: 3, agentScore: 3, taskCompletionRate: 3, predictionScore: 3 },
        { variantId: "b", variantLabel: "B", variantName: "Beta", targetUserScore: 5, expertScore: 5, agentScore: 5, taskCompletionRate: 5, predictionScore: 5 },
      ],
      weights,
    );
  ...
  it("recommends ship for the top variant", () => {
    const rankings = computeVariantRankings(
      [
        { variantId: "a", variantLabel: "A", variantName: "Alpha", targetUserScore: 5, expertScore: 5, agentScore: 5, taskCompletionRate: 5, predictionScore: 5 },
        { variantId: "b", variantLabel: "B", variantName: "Beta", targetUserScore: 1, expertScore: 1, agentScore: 1, taskCompletionRate: 1, predictionScore: 1 },
      ],
      weights,
    );
  ...
  it("recommends borrow for the second variant when the gap is small", () => {
    const rankings = computeVariantRankings(
      [
        { variantId: "a", variantLabel: "A", variantName: "Alpha", targetUserScore: 4, expertScore: 4, agentScore: 4, taskCompletionRate: 4, predictionScore: 4 },
        { variantId: "b", variantLabel: "B", variantName: "Beta", targetUserScore: 3.8, expertScore: 3.8, agentScore: 3.8, taskCompletionRate: 3.8, predictionScore: 3.8 },
      ],
      weights,
    );
